...
- The opt-in per-partition circuit breaker is checked before the bulkhead, before the first attempt — while open it rejects with `CircuitOpenError` and nothing is attempted.
